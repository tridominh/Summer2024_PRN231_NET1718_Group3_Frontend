...
export function StudentHome({ token, setToken }) {
          ...
          <div className="row mb-5 align-items-center">
            ...
            >
              <h2 className="text-black mb-4 font-weight-bold">
                Đăng yêu cầu linh hoạt
              </h2>
              <p className="mb-4">
                Bạn có thể mở các yêu cầu rất nhanh chóng, dễ dàng, với các tùy
                chỉnh linh hoạt giúp bạn tìm Gia sư phù hợp với tiêu chí của
                mình.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row justify-content-center">
            ...
            >
              <h2 className="section-title">Finding Tutor</h2>
              <p className="mb-5">
                Chúng tôi sẽ giới thiệu những gia sư tốt nhất phù hợp với yêu
                cầu của bạn
              </p>
              <p>
